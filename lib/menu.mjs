...
export async function showMainMenu() {
  ...
  const response = await prompts({
    ...
    choices: [
      ...
      // Phase 2: Quick Task Generation - Generate tasks from bugs/changes description without PRD
      {
        title: "Create Tasks (Quick Mode)",
        value: "create_tasks_quick",
        description: "Generate tasks from bugs/changes description (no PRD needed)",
      },
