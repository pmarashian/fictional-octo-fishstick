 ...
 * aspect, returning the selected filename for file operations to be handled elsewhere.
 *
 * File Format:
 * - Location: project/prds/ directory
...
export async function selectFileFromPRDsFolder() {
  ...
  try {
    ...
    // Exclude only TEMPLATE.md (reserved for generation template)
...
export async function interactiveLoop(
  ...
  let prompt = initialPrompt;  // Current prompt (modified with feedback on iterations)
