 ...
 */
function logAgentEvent(event, loggingState, logCallback) {
  switch (event.type) {
    case "system":
    case "user":
 ...
 * @param {Function} logCallback - Callback for logging messages
 */
function logSystemUserMessage(event, logCallback) {
 ...
 * @param {Function} logCallback - Callback for logging messages
 */
function logThinkingEvent(event, loggingState, logCallback) {
 ...
 * @param {Function} logCallback - Callback for logging messages
 */
function logToolCall(event, logCallback) {
 ...
 * @param {Function} logCallback - Callback for logging messages
 */
function logToolResult(event, loggingState, logCallback) {
  const toolName =
 ...
 * @param {Function} logCallback - Callback for logging messages
 */
function logAssistantMessage(event, logCallback) {
